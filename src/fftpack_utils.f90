submodule(fftpack) fftpack_utils
  use fftpack_kinds
contains
  pure module function fftfreq_unit_sampling(n) result(out)
    integer(ilp), intent(in) :: n
    integer(ilp), dimension(n) :: out
    integer :: i
  ...
  end function fftfreq_unit_sampling
  ...
  pure module function rfftfreq_unit_sampling(n) result(out)
    integer(ilp), intent(in) :: n
    integer(ilp), dimension(n) :: out
    integer :: i
  ...
  end function rfftfreq_unit_sampling
end submodule
